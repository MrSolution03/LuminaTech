    ...
    >
      <div className="container mx-auto px-6 flex items-center justify-between">
        ...
        <a href="#home" className="flex items-center space-x-2 group">
          ...
          <span className={`font-heading font-extrabold text-2xl tracking-tight ${scrolled ? 'text-slate-900' : 'text-slate-900'}`}>
      ...
      {/* Mobile Menu */}
      <div className={`lg:hidden transition-all duration-300 ease-in-out ${isOpen ? 'max-h-screen opacity-100 bg-white border-b' : 'max-h-0 opacity-0 overflow-hidden'}`}>
