        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            ...
            <p className="text-slate-600 leading-relaxed">
              Nous sommes un collectif de consultants, développeurs et créatifs basés en France, unis par la volonté d'offrir aux PME les mêmes outils que les grands groupes. Nous ne nous contentons pas de livrer du code ; nous bâtissons des partenariats durables.
            </p>
